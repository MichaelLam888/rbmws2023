...
const Template_7 = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <span className='blue_2'><h1>第一步 : 請跟以下示範圖片動作拍照</h1></span>
        ...
        {preview ? (
          ...
          <img src="https://zh22rbmsign.rbmoney.hk/image/kyc1.jpg" alt="Default" width="80%" />
        )}
      </div>
      {uploaded ? (
            <button className="step" onClick={handleClick9}>下一步</button>
        ) : (
