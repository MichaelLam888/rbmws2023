...
<br /><br />This document is a note of Agreement, but not part of Agreement. The details of Agreement should be referred to the Loan Agreement<br />本文乃摘記，不是協議的⼀部份。關於協議的詳請，請參閲貸款合約。<br />(a) Name and address of the money lender 放債⼈名稱及地址:<br />Name 名稱 : Lee Dor Cash Limited<br />Address 地址 : Unit 1412, 14/F, Lippo Sun Plaza, 28 Canton Road, Tsim Sha Tsui, Kowloon, Hong Kong<br />(b) Name and address of borrower(s) 借款⼈名稱及地址:<br />Name 名稱 : Test Address 地址 : Test<br />(c) Name and address of surety(s) (if any) 擔保⼈名稱及地址 (如有):<br />(d) Amount of the principal of the loan 貸款本⾦額:<br />HK$ 10,000.00 HONG KONG DOLLARS TEN THOUSAND ONLY<br />(e) Date of the making of the agreement 訂立協議⽇期: 23-Aug-2022<br />(f) Date of the making of the loan 作出貸款⽇期: 23-Aug-2022 <br />(g) Terms of repayment of the loan 償還貸款的條款: 12<br />(h) Form of security for the loan 貸款的保證形式: Nil.<br />(i) The rate of interest charged on the Loan expressed as a rate per cent per annum or the rate per cent per annum represented by the interest charged as calculated in accordance with Schedule 所收取的貸款利率，以年息百分率表<br />⽰，或以按照還款表計算的利息所代表的年息百分率表⽰: 21.328%<br />(j) Place of negotiation and completion of the agreement for the loan 貸款協議的洽商地點及完成地點:<br />Unit 1412, 14/F, Lippo Sun Plaza, 28 Canton Road, Tsim Sha Tsui, Kowloon, Hong Kong</p>
...
<p>I/We<br />關於本⼈/吾等 Test，<br />holder of HKID / Passport No. / BR Certificate No.<br />證件編號 Q123456(7) 的持有⼈(Address 地址: Test)，<br />hereby confirm that Lee Dor Cash Limited completed a comprehensive assessment of my ability to make repayments under the loan agreement, and have due regard to the outcome of the assessment in respect of my affordability.<br />得悉 利多喜有限公司 對本⼈的貸款協議經已進⾏全⾯的風險評估，充分慮及本⼈的負擔能⼒。<br />I hereby declare as follows:<br />本⼈特此聲明如下：</p>
